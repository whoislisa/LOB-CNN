...
class MulticlassVGG11(nn.Module):
    def __init__(self):
        super(MulticlassVGG11, self).__init__()
        # 加载 VGG11 模型的卷积部分（不包括全连接层）
        base_model = vgg11(pretrained=False)
...
if __name__ == "__main__":
    ...
    # 训练好的模型的存储路径
    save_path = "model_res_for_backtest/M_BinaryVGG11_e20_b64_l0.0004_D_CSI50_T_0424-1920.pt"
    #### args
