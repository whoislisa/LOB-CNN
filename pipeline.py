...
df_results = _U.traditional_ml_pipeline(entries=num_dataset, balance=False, data_type='num')
...
df_results = _U.traditional_ml_pipeline(entries=image_dataset, balance=False, data_type='img')
print(df_results.sort_values('F1', ascending=False))
